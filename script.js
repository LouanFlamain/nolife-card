let calculateAngle = function (e, item, parent) {
  ...
  item.style.transform = `rotateY(${calcAngleX}deg) rotateX(${-calcAngleY}deg) scale(1.5)`;
  parent.querySelector(
    ".inner-card-backface"
  ).style.transform = `rotateY(${calcAngleX}deg) rotateX(${-calcAngleY}deg) scale(1.5) translateZ(-4px)`;
